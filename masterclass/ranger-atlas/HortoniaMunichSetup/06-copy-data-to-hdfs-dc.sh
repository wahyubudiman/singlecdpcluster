...
hdfs dfs -put data/eu_countries.csv                 /hive_data/worldwidebank/eu_countries/
hdfs dfs -put data/us_customers_data.csv            /hive_data/worldwidebank/us_customers/
hdfs dfs -put data/ww_customers_data.csv            /hive_data/worldwidebank/ww_customers/
